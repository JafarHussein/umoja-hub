...
3. ✅ **Verification harness — throwaway `/__tokens` preview route.** A temporary internal route renders every `ui/` primitive in both modes for eyeballing during P3; no Storybook dependency added; the route is deleted at the end of V1.
