    ...
    return (
      <Page width="focus">
        ...
        <VerificationLockout
          ...
          message="An administrator verifies your faculty role before students can demonstrate their work to you. If you have not sent your credential letter, you can do that now."
