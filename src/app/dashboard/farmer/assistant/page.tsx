  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 py-8 md:px-8">
        {/* Page header */}
        <div className="mb-6">
          <h1 className="font-heading text-t1 text-fg mb-2">Farm Assistant</h1>
          <p className="font-body text-t4 text-fg-muted">
            Get expert agricultural guidance grounded in KEBS, PCPB, and KEPHIS standards.
          </p>
          <div className="mt-3 inline-flex items-center gap-2 px-3 py-1 bg-surface-raised border border-white/5 rounded-sm">
        ...
        {/* Disclaimer */}
        <p className="font-body text-t6 text-fg-disabled mt-4">
