...
export default async function FarmAssistantPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      {/* Page header */}
      <div>
        <h1 className="app-h1 text-app-ink">Farm Assistant</h1>
        ...
        <div className="mt-3 inline-flex items-center gap-2 rounded-app-pill border border-app-hairline bg-app-sunken px-3 py-1">
