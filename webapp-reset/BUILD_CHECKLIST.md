...
- [x] **Farmer** (11 screens: Home, Verification status, List produce, Orders+fulfil, Reviews & Trust, My listings, Money/ledger, Market prices, Group orders, Farm assistant, Profile) · [x] **Buyer** (12 screens: Home, Opportunity Review, Search, Discovery, Post a Need, Commit/checkout, Track+confirm+review, Procurement, Suppliers, Orders, Profile — Discovery-mobile deferred to a mobile pass) · [ ] Student · [ ] Lecturer · [ ] Admin
